export default function SelectCategory() {
  return (
    <div className="my-4 mb-6">
      ...
      >
        <option selected className="text-primary-800">
          Selecione a categoria
        </option>
        <option className="text-primary-800" value="Estudos">
          Estudos
        </option>
        <option className="text-primary-800" value="Alimentação">
          Alimentação
        </option>
        <option className="text-primary-800" value="Remédio">
          Remédio
        </option>
        <option className="text-primary-800" value="Combustível">
          Combustível
        </option>
      </select>
    </div>
