...
import {
  CandleTypeProps,
  KlineData,
} from '@/components/features/cripto/_components/charts/candlestick-chart'
import { CriptoCoinTypeResponse } from '@/components/features/cripto/_components/list-item'
